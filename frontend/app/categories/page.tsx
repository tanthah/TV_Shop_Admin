...
export default function CategoriesPage() {
    ...
    const fetchCategories = async () => {
        ...
        setError('');
        try {
            const res = await axios.get(`${baseURL}/api/categories/admin/list`, {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingCategory) {
                await axios.patch(`${baseURL}/api/categories/${editingCategory._id}`, fd, {
                    headers: {
                ...
                await axios.post(`${baseURL}/api/categories`, fd, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        Authorization: `Bearer ${Cookies.get('admin_token') || ''}`,
                    },
    ...
    const toggleStatus = async (category: Category) => {
        ...
        try {
            await axios.patch(`${baseURL}/api/categories/${category._id}/status`, {}, {
                headers: { Authorization: `Bearer ${Cookies.get('admin_token') || ''}` },
            });
    ...
    const removeCategory = async (id: string, name: string) => {
        ...
        if (result.isConfirmed) {
            try {
                ...
                Swal.fire('Lỗi', err.response?.data?.message || 'Không thể xoá danh mục', 'error');
            }
        }
    };
