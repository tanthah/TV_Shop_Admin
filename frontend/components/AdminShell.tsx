...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  const menu = [
    ...
    // Spacer/Group separator logic could be added here if needed, but linear list requested
    ...
    { key: 'reviews', label: 'Quản lý đánh giá', path: '/reviews' },
          ...
          <div className="flex items-center gap-3">
            ...
            {!collapsed && (
              <div className="flex flex-col animate-in fade-in duration-200">
                <span className="text-sm font-bold tracking-tight whitespace-nowrap text-white leading-tight">TV Shop</span>
